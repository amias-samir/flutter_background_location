...
internal data class TrackingConfiguration(
    val movingIntervalMs: Long = 5_000L,
    val movingDistanceFilterMeters: Float = 5f,
    val stationaryIntervalMs: Long = 20_000L,
    val stationaryDistanceFilterMeters: Float = 20f,
    ...
    val movingConfirmationCount: Int = 1,
    val activityRecognitionIntervalMs: Long = 5_000L,
    val captureIntent: String = "adaptive",
    val activityFreshnessThresholdMs: Long = 30_000L,
    ...
    val motionEvidenceFreshnessMs: Long = 30_000L,
    val sensorProbeDurationMs: Long = 4_000L,
    val sensorProbeCooldownMs: Long = 20_000L,
    val sensorProbeMaximumDurationPerHourMs: Long = 180_000L,
